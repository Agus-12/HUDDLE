/* E2E v91: buscar en la pestaña Solo reproduce individual (antes la
 * búsqueda SIEMPRE armaba una sala) y las carátulas de animes ya no se
 * proxiean dos veces (el póster roto "?" azul en continuar-viendo) + todo
 * v90→v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v91'"), 'servidor en v91');
  ok(js.includes("const APP_VERSION = 'v91'"), 'cliente en v91');
  ok(idx.includes('id="verBadge">v91'), 'badge v91');
  ok(idx.includes('/app.js?v=91') && idx.includes('/style.css?v=91'), 'cache-busters v91');
  /* hls.js vendored */
