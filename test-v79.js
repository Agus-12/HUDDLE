/* E2E v79: TODO se ve vertical en el celular (invitación, pantalla de
 * espera y selector de episodios girados) + quitar entradas de
 * "Continuar viendo" — más todo v78/v77/v76 */
const fs = require('fs');
...
(async () => {
  ...
  /* v65 */
  ok(srv.includes("const UI_VERSION = 'v79'"), 'servidor en v79');
  ok(js.includes("const APP_VERSION = 'v79'"), 'cliente en v79');
