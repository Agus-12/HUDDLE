/* E2E v78: la sala SIEMPRE se ve vertical (girada si el celular está
 * horizontal) + "Continuar viendo" (retomar donde te quedaste, compartido
 * con el invitado) — más todo v77/v76 */
const fs = require('fs');
...
(async () => {
  ...
  /* v65 */
  ok(srv.includes("const UI_VERSION = 'v78'"), 'servidor en v78');
  ok(js.includes("const APP_VERSION = 'v78'"), 'cliente en v78');
