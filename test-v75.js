/* E2E v75: botones de episodio en la barra de abajo (debajo de
 * "Ampliar", fuera de la película), pantalla de espera como siempre,
 * y AMBOS usuarios ven lo mismo al cambiar de episodio — más todo v74 */
const fs = require('fs');
...
(async () => {
  ...
  /* v65 */
  ok(srv.includes("const UI_VERSION = 'v75'"), 'servidor en v75');
  ok(js.includes("const APP_VERSION = 'v75'"), 'cliente en v75');
