/* E2E v85: episodios VISTOS en el selector (✓ verde completa, ◐ ámbar
 * a medias, con "Quedaste en mm:ss") — nuevos /api/vistos + progreso
 * que alimenta las marcas + todo v84/v83/v82/v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v85'"), 'servidor en v85');
  ok(js.includes("const APP_VERSION = 'v85'"), 'cliente en v85');
  ok(idx.includes('id="verBadge">v85'), 'badge v85');
  ok(idx.includes('/app.js?v=85') && idx.includes('/style.css?v=85'), 'cache-busters v85');
  /* hls.js vendored */
