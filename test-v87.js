/* E2E v87: tres pestañas (Salas / Juntos / Solo, iconos SVG sin emojis),
 * sin botón "Crear sala" — elegir una peli en Juntos crea la sala sola —
 * y fix del 404: las pelis del buscador apuntan a cine-calidad (no a
 * cuevana.mov, que ya responde 404) + todo v86→v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v87'"), 'servidor en v87');
  ok(js.includes("const APP_VERSION = 'v87'"), 'cliente en v87');
  ok(idx.includes('id="verBadge">v87'), 'badge v87');
  ok(idx.includes('/app.js?v=87') && idx.includes('/style.css?v=87'), 'cache-busters v87');
  /* hls.js vendored */
