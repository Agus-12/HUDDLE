/* E2E v92: SALA NATIVA — en Juntos, si la peli se resuelve como en Solo,
 * todos la reproducen directo en su navegador (sin navegador remoto),
 * sincronizados por el reloj de la sala; pantalla de carga mínimo 5s;
 * el espejo queda de respaldo + todo v91→v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v92'"), 'servidor en v92');
  ok(js.includes("const APP_VERSION = 'v92'"), 'cliente en v92');
  ok(idx.includes('id="verBadge">v92'), 'badge v92');
  ok(idx.includes('/app.js?v=92') && idx.includes('/style.css?v=92'), 'cache-busters v92');
  /* hls.js vendored */
