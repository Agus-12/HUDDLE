/* E2E v76: al voltear el celular se amplía solo y al levantarlo
 * regresa al modo sala — más todo v75 (botones de episodio abajo,
...
(async () => {
  ...
  /* v65 */
  ok(srv.includes("const UI_VERSION = 'v76'"), 'servidor en v76');
  ok(js.includes("const APP_VERSION = 'v76'"), 'cliente en v76');
