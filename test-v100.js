/* E2E v100: EL PÓSTER DE VERDAD — WP API, no el still del episodio 1
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v100'"), 'servidor en v100');
  ok(js.includes("const APP_VERSION = 'v100'"), 'cliente en v100');
  ok(idx.includes('id="verBadge">v100'), 'badge v100');
  ok(idx.includes('/app.js?v=100') && idx.includes('/style.css?v=100'), 'cache-busters v100');
  /* hls.js vendored */
