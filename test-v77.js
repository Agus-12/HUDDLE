/* E2E v77: la pantalla completa siempre horizontal (ampliar en
 * vertical gira la vista) + al volver de pantalla apagada la sala se
 * acomoda sola — más todo v76 (voltear = ampliar) */
const fs = require('fs');
...
(async () => {
  ...
  /* v65 */
  ok(srv.includes("const UI_VERSION = 'v77'"), 'servidor en v77');
  ok(js.includes("const APP_VERSION = 'v77'"), 'cliente en v77');
