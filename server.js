...
const UI_VERSION = 'v233'; // 233: fix Byse trailing-slash bug (Siniestro "peli caída")
...
async function nv2Ficha(pref) {
  ...
  return { ok: eps.length > 0, slug: pref, titulo: nvTituloBonito(pref), poster: img, episodios: eps };
}
