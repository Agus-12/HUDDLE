...
const UI_VERSION = 'v194'; // versión de la interfaz que sirve este servidor
    ...
    if (url.pathname === '/api/search' && req.method === 'GET') {
      ...
      if (qD.length) {
        ...
        for (const [sl, lct] of lctHits.reverse()) {
          r.resultados.unshift({ title: lct.titulo, url: LCT_BASE + 'serie/' + lct.lctId, img: CARI_PORTADAS.get(sl) || '', site: 'Cartoons', extra: 'Lacartoons · latino' });
        }
      }
