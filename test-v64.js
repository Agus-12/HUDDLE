/* E2E v64: PELIS de cine-calidad arrancan solas (bypass del protector de
 * enlaces decodificando goodstream) + todo lo de v63 (Latanime, temporadas
 * reales, scrollbars ocultos, controles auto-ocultables) */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v64'"), 'servidor en v64');
  ok(js.includes("const APP_VERSION = 'v64'"), 'cliente en v64');
  ok(srv.includes('String.fromCharCode(ch.charCodeAt(0) - 2)'), 'bypass del protector de enlaces (decodifica goodstream)');
