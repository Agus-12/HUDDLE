/* E2E v89: el reproductor individual NACE a pantalla completa en el
 * celular (mismo toque = el navegador lo permite) — al voltear el
 * teléfono SE QUEDA ACOSTADO: solo se endereza el video, sin pedir
 * pantalla completa de nuevo; al cerrar se suelta + todo v88→v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v89'"), 'servidor en v89');
  ok(js.includes("const APP_VERSION = 'v89'"), 'cliente en v89');
  ok(idx.includes('id="verBadge">v89'), 'badge v89');
  ok(idx.includes('/app.js?v=89') && idx.includes('/style.css?v=89'), 'cache-busters v89');
  /* hls.js vendored */
