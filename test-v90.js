/* E2E v90: modo Solo 100% — los ANIMES se ven en Solo (mp4 directo de
 * mp4upload, extraído sin navegador) y las pelis SIN goodstream caen a
 * vimeos (HLS 720p); el proxy aprende Range para moverse en el mp4 + todo
 * v89→v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v90'"), 'servidor en v90');
  ok(js.includes("const APP_VERSION = 'v90'"), 'cliente en v90');
  ok(idx.includes('id="verBadge">v90'), 'badge v90');
  ok(idx.includes('/app.js?v=90') && idx.includes('/style.css?v=90'), 'cache-busters v90');
  /* hls.js vendored */
