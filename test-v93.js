/* E2E v93: ANIMES ROBUSTOS — el resolvedor de animes reintenta los
 * cuerpos racionados, detecta los archivos borrados (Evangelion),
 * verifica que el mp4 SIRVA antes de prometerlo y tiene fallback por
 * navegador; goodstream reintenta el cuerpo sin m3u8 (Conclave) +
 * todo v92→v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v93'"), 'servidor en v93');
  ok(js.includes("const APP_VERSION = 'v93'"), 'cliente en v93');
  ok(idx.includes('id="verBadge">v93'), 'badge v93');
  ok(idx.includes('/app.js?v=93') && idx.includes('/style.css?v=93'), 'cache-busters v93');
  /* hls.js vendored */
