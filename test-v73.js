/* E2E v73: la barrita DENTRO del reproductor pero pegada casi a su
 * borde de abajo (sin aire) — más todo v72/v71/v70 (play centrado,
 * búsqueda Cuevana+Latanime, sin AnimeD23) */
const fs = require('fs');
...
(async () => {
  ...
  /* v65 */
  ok(srv.includes("const UI_VERSION = 'v73'"), 'servidor en v73');
  ok(js.includes("const APP_VERSION = 'v73'"), 'cliente en v73');
