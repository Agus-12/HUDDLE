/* E2E v99: ARRANQUE RÁPIDO DE SERIES + PÓSTER A PRUEBA DE BALA
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v99'"), 'servidor en v99');
  ok(js.includes("const APP_VERSION = 'v99'"), 'cliente en v99');
  ok(idx.includes('id="verBadge">v99'), 'badge v99');
  ok(idx.includes('/app.js?v=99') && idx.includes('/style.css?v=99'), 'cache-busters v99');
  /* hls.js vendored */
  ...
  ok(!!entSala && !/STILL_DEL_CAPITULO/.test(entSala.img || ''), 'entrada vieja de sala (sin serie/ep) también muestra el póster de la serie');
