/* E2E v94: AUDIO EN ESPAÑOL — los masters de goodstream traen el
 * inglés como DEFAULT (las series "venían en inglés"): el player ahora
 * elige la pista de audio español cuando existe, en Solo, en la sala
 * nativa y en Safari + todo v93→v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v94'"), 'servidor en v94');
  ok(js.includes("const APP_VERSION = 'v94'"), 'cliente en v94');
  ok(idx.includes('id="verBadge">v94'), 'badge v94');
  ok(idx.includes('/app.js?v=94') && idx.includes('/style.css?v=94'), 'cache-busters v94');
  /* hls.js vendored */
