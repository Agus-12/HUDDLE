/* E2E v66: vista normal corregida — "Toca para empezar" al CENTRO,
 * barrita abajo y botones 10/30/lupa ARRIBA de la barrita (pantalla
 * completa sin cambios) + directorio v65 (Latanime primero, logos
 * propios) + tira de mensajes sobre los controles + todo lo de v64 */
const fs = require('fs');
...
(async () => {
  ...
  /* v65 */
  ok(srv.includes("const UI_VERSION = 'v66'"), 'servidor en v66');
  ok(js.includes("const APP_VERSION = 'v66'"), 'cliente en v66');
