/* E2E v88: destello ±10s con iconos SVG (sin emojis), "Continuar viendo"
 * por pestaña (sala→Juntos, individual→Solo), reproductor individual
 * SIEMPRE horizontal (girado con celular vertical) e inicio SIEMPRE
 * vertical (girado con celular acostado) + todo v87→v81. */
const fs = require('fs');
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v88'"), 'servidor en v88');
  ok(js.includes("const APP_VERSION = 'v88'"), 'cliente en v88');
  ok(idx.includes('id="verBadge">v88'), 'badge v88');
  ok(idx.includes('/app.js?v=88') && idx.includes('/style.css?v=88'), 'cache-busters v88');
  /* hls.js vendored */
