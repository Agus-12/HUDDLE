/* E2E v97: ANIMEFLV DE VUELTA — otra fuente de animes con mp4upload
...
(async () => {
  ...
  ok(srv.includes("const UI_VERSION = 'v97'"), 'servidor en v97');
  ok(js.includes("const APP_VERSION = 'v97'"), 'cliente en v97');
  ok(idx.includes('id="verBadge">v97'), 'badge v97');
  ok(idx.includes('/app.js?v=97') && idx.includes('/style.css?v=97'), 'cache-busters v97');
  /* hls.js vendored */
